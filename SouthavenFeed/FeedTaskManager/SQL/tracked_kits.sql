...
SELECT
  ...
  COALESCE(COUNT_OF_NO_ACTION_REQUIRED, 0) +
  COALESCE(COUNT_OF_CORPORATE_HOLD, 0) +
  COALESCE(COUNT_OF_EMPTY, 0) +
  COALESCE(COUNT_OF_MANUEL_INVESTIGATION_REQUIRED, 0) +
  COALESCE(COUNT_OF_COMPLETE_PUTAWAY, 0) +
  COALESCE(COUNT_OF_PICK_SHORTAGE, 0) +
  COALESCE(COUNT_OF_NO_STOCK_AVAILABLE, 0) +
  COALESCE(COUNT_OF_COMPLETE_NEW_KIT_BUILD, 0) +
  COALESCE(COUNT_OF_COMPLETE_REPLENISHMENTS, 0) +
  COALESCE(COUNT_OF_STOCK_AVAILABLE, 0) AS TOTAL_COUNT_OF_SERIALS,
...
GROUP BY
  ...
  COUNT_OF_STOCK_AVAILABLE,
  STOCK_AVAILABLE,
  COMPLETE_NEW_KIT_BUILD,
  NO_STOCK_AVAILABLE,
  PICK_SHORTAGE,
  COMPLETE_REPLENISHMENTS,
  COMPLETE_PUTAWAY,
  MANUEL_INVESTIGATION_REQUIRED,
  EMPTY,
  CORPORATE_HOLD,
