...
WHERE
  ...
  AND TO_DATE(TO_CHAR(M.COMPLETED_DATE, 'MM-DD-YYYY'), 'MM-DD-YYYY') BETWEEN TO_DATE(
      TO_CHAR(CURRENT_DATE - 2, 'MM-DD-YYYY'), 'MM-DD-YYYY') AND TO_DATE(
      TO_CHAR(CURRENT_DATE, 'MM-DD-YYYY'), 'MM-DD-YYYY')
